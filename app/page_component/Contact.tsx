      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0 ">
          <div className="group flex flex-col items-center space-x-2 pt-8 xl:col-span-1 ml-10 mt-5">
            {/* 地圖 image */}
            <div className="h-40 w-80 ml-10 "> {/* 調整這裡以符合您的設計需求 */}
              <Image
                ...
                width={400}
                height={400}
                className="transform group-hover:scale-110 transition-transform rounded-xl"
              />
            </div>
          </div>
          <div className="prose max-w-none pb-8 pt-8 dark:prose-invert xl:col-span-2 ml-20">
            {/* 聯絡資訊 */}
